...
const argv = require('yargs')
  ...
  .option('sequential', {
    alias: 's',
    describe: 'Run all tests serially in the current process, rather than creating a worker pool of child processes that run tests. This can be useful for debugging.', //eslint-disable-line
    default: false,
    type: 'boolean'
  })
  .option('coverage', {
